    ...
    <div class="flex justify-center w-full h-full my-auto xl:gap-14 lg:justify-normal md:gap-5 draggable">
        <div class="flex items-center justify-center w-full lg:p-12">
            <div class="bg-white shadow-2xl border border-gray-300 rounded-3xl p-8">
                <form action="{{ route('aregister.post') }}" method="POST" class="flex flex-col w-full h-full pb-6 text-center bg-white rounded-3xl" onsubmit="return registerForm()">
                    @csrf
                    ...
                    <div class="bg-white rounded-lg relative mb-8">
                        <div class="relative">
                            <input type="password" id="password" name="password" class="peer input-field h-12 w-full px-4 py-2 border-2 border-fern-green rounded-lg text-fern-green placeholder-transparent focus:outline-none focus:ring-2 focus:ring-kelly-green focus:border-kelly-green" placeholder="Password"/>
                            <label for="password" class="absolute left-4 -top-3.5 bg-white px-1 text-sm text-fern-green peer-placeholder-shown:text-base peer-placeholder-shown:text-fern-green peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-fren-green peer-focus:text-sm transition-all">
                                Password
                            </label>
                    ...
                    <div class="bg-white rounded-lg relative mb-8">
                        <div class="relative">
                            <input type="text" id="phone_number" name="phone_number" class="peer bg-transparent h-12 w-full px-4 py-2 border-2 border-fern-green rounded-lg text-fern-green placeholder-transparent focus:outline-none focus:ring-2 focus:ring-kelly-green focus:border-kelly-green" placeholder="Phone Number" required />
                            <label for="phone_number" class="absolute left-4 -top-3.5 bg-white px-1 text-sm text-fern-green peer-placeholder-shown:text-base peer-placeholder-shown:text-fern-green peer-placeholder-shown:top-2 peer-focus:-top-3.5 peer-focus:text-fern-green peer-focus:text-sm transition-all">
                                Phone Number
                            </label>
                            <p id="phone_number-error" class="text-xs text-red text-left ml-3 absolute hidden">
                                Phone number cannot be more than 20 digits.
                            </p>
                        </div>
                    </div>
                    ...
                    <p class="text-sm leading-relaxed text-fern-green">
                        ...
                        <a href="alogin" class="font-bold text-fern-green hover:underline">Login Account</a>
                    </p>
                </form>
            </div>
        </div>
